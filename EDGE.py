    ...
    **kwargs: The keywords arguments used to make changes to the sample file. Available
    ...
    if 'epsilon' in kwargs:
        ...
        if epsVal == 0.0001:
            ...
            if fullText[90][0] == '#' and fullText[91][0] == '#':
                fullText[90] = fullText[90][1:]     # Remove the pound at 0.001
                fullText[91] = fullText[91][1:]
            ...
            if fullText[93][0] == '#' and fullText[94][0] == '#':
                fullText[93] = fullText[93][1:]     # Remove the pound at 0.01
                fullText[94] = fullText[94][1:]
                fullText[83] = '#' + fullText[83]   # Add the pound at 0.0001
                fullText[84] = '#' + fullText[84]
            else:
                raise ValueError('JOB_FILE_CREATE: There is a comment problem at eps=0.01')
        elif epsVal == 0.1:
            if fullText[96][0] == '#' and fullText[97][0] == '#':
                fullText[96] = fullText[96][1:]     # Remove the pound at 0.1
                fullText[97] = fullText[97][1:]
                fullText[83] = '#' + fullText[83]   # Add the pound at 0.0001
                fullText[84] = '#' + fullText[84]
            else:
                raise ValueError('JOB_FILE_CREATE: There is a comment problem at eps=0.1')
        elif epsVal == 0.2:
            if fullText[99][0] == '#' and fullText[100][0] == '#':
                fullText[99] = fullText[99][1:]     # Remove the pound at 0.2
                fullText[100]= fullText[100][1:]
                fullText[83] = '#' + fullText[83]   # Add the pound at 0.0001
                fullText[84] = '#' + fullText[84]
            else:
                raise ValueError('JOB_FILE_CREATE: There is a comment problem at eps=0.2')
        elif epsVal == 0.5:
            if fullText[102][0] == '#' and fullText[102][0] == '#':
                fullText[102]= fullText[102][1:]    # Remove the pound at 0.5
                fullText[103]= fullText[103][1:]
                fullText[83] = '#' + fullText[83]   # Add the pound at 0.0001
                fullText[84] = '#' + fullText[84]
            else:
                raise ValueError('JOB_FILE_CREATE: There is a comment problem at eps=0.5')
        elif epsVal == 1.0:
            if fullText[105][0] == '#' and fullText[106][0] == '#':
                fullText[105]= fullText[105][1:]    # Remove the pound at 1.0
                fullText[106]= fullText[106][1:]
                fullText[83] = '#' + fullText[83]   # Add the pound at 0.0001
                fullText[84] = '#' + fullText[84]
            else:
